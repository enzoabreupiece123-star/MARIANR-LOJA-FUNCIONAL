...
export const AdminOrdersView: React.FC<AdminOrdersViewProps> = ({
  ...
  return (
    <div className="space-y-6">
              ...
              >
                ...
                <div className="p-4 sm:p-5 grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    {/* PIX Receipt Proof Display */}
                    <div className="pt-2 border-t border-[#f0ebe3]">
                      <div className="text-[10px] font-bold uppercase tracking-wider text-[#8c8278] mb-1 flex items-center gap-1">
                        <FileCheck className="w-3.5 h-3.5 text-[#8e6e34]" />
                        Comprovante do PIX:
                      </div>

                      {order.receiptImage ? (
                        <div className="p-2.5 bg-emerald-50/70 border border-emerald-200 rounded-xl flex items-center justify-between gap-3">
                          <div
                            onClick={() => setSelectedReceiptView(order.receiptImage!)}
                            className="flex items-center gap-2.5 min-w-0 cursor-pointer group"
                          >
                            <img
                              src={order.receiptImage}
                              alt="Comprovante PIX"
                              className="w-10 h-14 object-cover rounded-lg border border-emerald-300 bg-white shrink-0 group-hover:scale-105 transition-transform shadow-2xs"
                            />
                            <div className="min-w-0">
                              ...
                              <p className="text-[10px] text-emerald-700 mt-0.5 group-hover:underline">
                                Clique para ampliar
                              </p>
                            </div>
                          </div>
                          ...
                          <button
                            type="button"
                            onClick={() => setSelectedReceiptView(order.receiptImage!)}
                            className="px-2.5 py-1.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg text-[10px] font-semibold tracking-wide shrink-0 transition-colors flex items-center gap-1 shadow-2xs"
                          >
                        ...
                        <div className="p-2 bg-stone-50 border border-stone-200 rounded-lg flex items-center gap-1.5 text-[11px] text-stone-500 italic">
                          <AlertCircle className="w-3.5 h-3.5 text-stone-400 shrink-0" />
                          <span>Pedido sem comprovante anexado no sistema.</span>
                        </div>
                      )}
                    </div>
                  </div>
      ...
      {/* Modal de Visualização do Comprovante PIX em Alta Resolução */}
      {selectedReceiptView && (
        <div
        ...
        >
          <div
            className="bg-white rounded-2xl max-w-xl w-full max-h-[92vh] overflow-hidden flex flex-col p-4 sm:p-5 space-y-3 shadow-2xl"
          ...
          >
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-stone-500">
                    Conferência da transferência enviada pela cliente
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="overflow-auto max-h-[70vh] flex items-center justify-center bg-stone-100 p-2 rounded-xl border border-stone-200">
              <img
                src={selectedReceiptView}
                alt="Comprovante de Pagamento PIX"
                className="max-h-[66vh] max-w-full object-contain rounded-lg shadow-sm"
              />
            </div>
